...
import { X, CreditCard, Landmark, PiggyBank } from "lucide-react";
  ...
  return (
    <>
      ...
      <div className="fixed inset-x-4 top-1/2 z-50 mx-auto max-w-md -translate-y-1/2 rounded-2xl border border-zinc-200 bg-white p-6 shadow-xl dark:border-zinc-800 dark:bg-zinc-900">
        ...
        {/* resumo da fatura */}
        <div className="mb-5 rounded-lg border border-zinc-200 bg-zinc-50 px-4 py-3 dark:border-zinc-800 dark:bg-zinc-900/50">
